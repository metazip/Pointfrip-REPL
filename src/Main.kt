...
const val cthelpinfo: String = "https://www.github.com/metazip/Pointfrip-REPL"
...
const val ctcomp: String    = "" + 176.toChar()
const val ctcomp2: String   = "" + 248.toChar()
...
const val ctspecial: String = "()[]{},;" + ctquote + ctquote2 + ctivar + ctcomp + ctcomp2 // unvollständig
...
// ----- initialisation
    ...
    var idcompose: Ident = newidentfunc(ctcomp,::fcompose)
    var idcompose2: Ident = newidentfunc("o",::fcompose)
    var idcompose3: Ident = newidentfunc("∘",::fcompose)
    var idcompose4: Ident = newidentfunc(ctcomp2,::fcompose)
...
val itxt: String = vm.prelude()
var otxt: String = vm.toValue(vm.deflines(vm.splitTo(itxt,"\n")))
var pfquit: Boolean = false
var line: String = ""
var res: Any = Nil()
...
fun splitLines(str: String): Any {
    ...
    while (i > 0) {
        ...
        list = Cell(str.substring(i,k),vm.xcons,list)
        if (i == 0) break
            ...
            */
            ...
            5.toLong() -> {  // savetext
                ...
                val wname = when (wself) {
                    is Ident  -> lastName(wself.pname)
                    is String -> lastName(wself)
                    else      -> ""      }
                if (wname!="") {
            ...
            */
            ...
            10.toLong() -> {  // run
                ...
                if (rget !is String)
                    ...
                    Runtime.getRuntime().exec(rget.split(" ").toTypedArray())
...
fun main() {
    ...
    while (!pfquit) {
        ...
        //pfquit = (line.trim() == "quit")
        res = vm.calc(line)
        while (res is Act) { res = doAct(res as Act) }
        println(vm.toValue(res))
...
fun mainabc() {      //   help:()     new ?      help:name    save:datei1.txt     load:datei1.txt     ???
        // (fact aa)°0,iota°10
    ...
    println(vm.toValue(vm.calc("identlist")))
